<template>
  <TabBar>
    <TabBarItem activeColor="#e0620d" path="/home">
      <div slot="item-icon">
    ...
    <TabBarItem activeColor="#e0620d" path="/category">
      <div slot="item-icon">
    ...
    <TabBarItem activeColor="#e0620d" path="/cart">
      <div slot="item-icon">
    ...
    <TabBarItem activeColor="#e0620d" path="/profile">
      <div slot="item-icon">
